        ...
        <div className="container-premium">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              ...
              <button onClick={() => scrollToSection('wellness')} className="text-muted-foreground hover:text-foreground transition-colors">
                Wellness
              </button>
              <button onClick={() => scrollToSection('blockchain')} className="text-muted-foreground hover:text-foreground transition-colors">
                Blockchain
              </button>
            </nav>
          ...
          {isMenuOpen && (
            <div className="lg:hidden py-4 border-t border-line">
              <nav className="flex flex-col space-y-3">
                ...
                <button onClick={() => scrollToSection('wellness')} className="text-left text-muted-foreground hover:text-foreground transition-colors">
                  Wellness
                </button>
                <button onClick={() => scrollToSection('blockchain')} className="text-left text-muted-foreground hover:text-foreground transition-colors">
                  Blockchain
                </button>
        ...
        <div className="container-premium">
          <ScrollReveal>
            <div className="flex justify-center">
              <p className="text-muted-foreground text-center mb-8">Trusted by leading companies</p>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center opacity-50">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="h-12 bg-muted/20 rounded-lg flex items-center justify-center">
